...
class CustomCurrentChats extends StatefulWidget {
  const CustomCurrentChats({super.key});

  @override
  State<CustomCurrentChats> createState() => _CustomCurrentChatsState();
}

class _CustomCurrentChatsState extends State<CustomCurrentChats>  {
